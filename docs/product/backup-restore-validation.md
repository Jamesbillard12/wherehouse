...
- Automated implementation: 84 backend tests passed on `feature/mvp-backup-restore`, including 18
  Phase 6 artifact/provider/PostgreSQL/Dropbox tests; changed-code Ruff passed. Web 23/23 and mobile
  8/8 tests passed, and API-client/web/mobile TypeScript checks passed.
