...
| Provider-neutral backup semantics with the first supported local/external-SSD destination | NAS, SMB/NFS, S3, Dropbox, B2, OneDrive, Google Drive providers and rich retention UI |
